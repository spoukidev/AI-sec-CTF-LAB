...
Manipulate generated JSON into an internal-alert action.

## Vulnerability

Generated structured data is executed as though it were trusted code.
...
~~~mermaid
flowchart LR
    Prompt --> ModelJSON --> Executor --> AlertStore
~~~
...
Generated structured data is executed as though it were trusted code. The deliberately vulnerable engine makes this behavior deterministic so the lesson does not depend on a commercial model.
...
Parse strict schemas, allowlist actions, validate identifiers, and authorize independently.
